...
const activeOverrides = ref<Partial<GemDNA>>({})
...
const dna        = ref<GemDNA | null>(null)

function renderSeed(s: string, overrides: Partial<GemDNA> = {}) {
  const seed            = s.trim() || 'seedstone'
...
function onGalleryPick({ seed, overrides }: { seed: string; overrides: Partial<GemDNA> }) {
    ...
    <div class="content">
      ...
      <footer class="footer">
        <p>
          ...
          ·
          <a href="https://github.com/titangmz/seedstone" target="_blank" rel="noopener">seedstone on GitHub</a>
        </p>
      </footer>
