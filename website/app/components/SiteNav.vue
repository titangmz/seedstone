...
.site-nav.scrolled {
  background: oklch(0.055 0.01 280 / .82);
...
.nav-primary {
  ...
  color: #0a0712;
  white-space: nowrap;
  box-shadow: 0 1px 0 oklch(0.85 0.1 290 / .5) inset, 0 8px 28px -10px oklch(0.7 0.15 285 / .65);
  transition: transform .15s, box-shadow .25s;
}
.nav-primary:hover {
  transform: translateY(-1px);
  box-shadow: 0 1px 0 oklch(0.9 0.1 290 / .6) inset, 0 14px 38px -12px oklch(0.7 0.15 285 / .85);
}
