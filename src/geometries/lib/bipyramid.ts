...
import { flatNormalGeo, pushTri, extractFlatNormals } from './geometry';

/**
 * Bipyramid with exactly N triangular faces (k = N/2 equatorial vertices).
 *
 * Works for any even N ≥ 6 (and N = 4 as a tetrahedron special case).
 ...
 *
 * Examples: 6 → triangular, 8 → octahedron, 10 → d10, 20 → d20, 100 → d100.
 *
