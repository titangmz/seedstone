...
export const gemTraits = {
  ...
  lights: {
    ...
    orbits: [
      ...
      { color: 0xffffff, tint: "accent2" as Tint, intensity: 120, radius: 1.5, speed:  0.8,  phaseDeg: 240, y: -0.2 },
      { color: 0xc8d8ff, tint: null,        intensity:  80, radius: 2.0, speed: -0.3,  phaseDeg: 180, y:  1.4 },
    ],
